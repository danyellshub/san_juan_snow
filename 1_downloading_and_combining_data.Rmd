...
#Grab only the name of the file by splitting out on forward slashes
splits_2 <- str_split_fixed(links_2,'/',5)

#Keep only the 5th column
dataset_2 <- splits_2[,5] 

#generate a file list for where the data goes
file_names_2 <- paste0('data/',dataset_2)

map2(links_2,file_names_2,download.file)
...
forcing_data <- map_dfr(file_names_2, forcing_reader)

forcing_colnames <- setNames(forcing_data, headers1)
